...
# sed -i -e "s/__REPLACE_WITH_OtelTraces_ENDPOINT__/${OSIS_TRACES_URL}/g" 02-otel-collector/kubernetes/01-configmap.yaml
# sed -i -e "s/__REPLACE_WITH_OtelLogs_ENDPOINT__/${OSIS_LOGS_URL}/g" 02-otel-collector/kubernetes/01-configmap.yaml
# sed -i -e "s/__REPLACE_WITH_OtelMetrics_ENDPOINT__/${OSIS_METRICS_URL}/g" 02-otel-collector/kubernetes/01-configmap.yaml
# sed -i -e "s/__AWS_REGION__/${AWS_REGION}/g" 02-otel-collector/kubernetes/01-configmap.yaml
...
push_images_ecr '02-user-service' 'user-service'
push_images_ecr '03-product-service' 'product-service'